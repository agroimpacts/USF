...
nytract <- st_read("C://CLARK//GEOSPAAR//floodlightblm//data//nyct2020.shp")

# This is the crs for NYC for future use
ny_crs <- st_crs(nytract)

# Geojson of NYC public housing developments 
nycha <- st_read("C://CLARK//GEOSPAAR//floodlightblm//data//nycha.geojson") %>% 
  st_transform(ny_crs)
...
```{r, eval = FALSE}
blm_csv <- read.csv("C://CLARK//GEOSPAAR//floodlightblm//data//blmprotestpts.csv")

s3 <- stack("C://CLARK//GEOSPAAR//floodlightblm//data//bm_nyc.grd")
...
polo_roll <- polo %>% mutate(month_av = rollapply(polo[[1]], 
...
polo_frame_full_full <- extract(x = polo_s2,
