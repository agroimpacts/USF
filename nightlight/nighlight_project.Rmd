...
s <- stack("~/Clark/RA-ing/SummerInstitute/nightlight/data/bm_nyc_cen.grd")
...
mean_sc <- mask(mean_s, st_transform(nytract, st_crs(mean_s)))#nytract)
plot(mean_sc)
...
```{r, out.width = "60%", echo = FALSE, fig.align = 'center'}
#nitr::include_graphics("graphics\\ph_plot.png")
```
