...
ui <- dashboardPage(
    skin = "black",
    dashboardHeader(title = "Risk, Value and Geographies of Policing - 2020",
                    titleWidth = 700),
    dashboardSidebar(
